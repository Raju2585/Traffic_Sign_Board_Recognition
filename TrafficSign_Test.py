...
model = load_model('mymode50epcs.h5')
...
def voice_alert():
    global classIndex, class_name
    while True:
        if classIndex is not None and class_name is not None:
            text_to_speech(class_name)  # Speak the class name
            classIndex = None
            class_name = None
